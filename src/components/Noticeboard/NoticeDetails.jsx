...
const NoticeDetails = () => {
 ...
 <span>Posted: <span className="text-slate-800 dark:text-white font-bold">
    {(() => {
      const d = notice.createdAt || notice.date;
      return d && !isNaN(new Date(d).getTime()) ? new Date(d).toLocaleDateString() : "recently";
    })()}
  </span></span>
 </div>
